...
def inject_app_style(theme_mode="Streamlit"):
    ...
    st.markdown(
        ...
        :root {
            ...
            --dap-chat-bg: var(--secondary-background-color); /* Dùng màu nền phụ (đặc) cho chatbot */
        ...
        /* Đồng bộ kích thước tab đang mở (.nav-current) và tab bình thường để không bị đẩy/lấn nhau */
        .nav-current {
            border-radius: 12px;
        ...
        /* Fixed Streamlit chatbot panel (Thu hẹp chiều ngang còn 315px, nền đặc không trong suốt) */
        .st-key-floating_chat_panel {
            position: fixed !important;
            right: 24px !important;
            bottom: 118px !important;
            width: 315px !important; /* Đã thu nhỏ xuống 70% (từ 450px) */
            max-width: calc(100vw - 48px) !important;
            max-height: calc(100vh - 150px) !important;
            overflow-y: auto !important;
            z-index: 2147483600 !important;
            background: var(--dap-chat-bg) !important; /* Xử lý lỗi nền trong suốt */
            ...
            box-shadow: 0 28px 76px rgba(0, 0, 0, 0.60) !important;
            padding: 0.75rem !important; /* Thu nhỏ padding để có thêm không gian */
            opacity: 1 !important;
            backdrop-filter: blur(0px) !important; /* Tắt bộ lọc trong suốt */
        }
        ...
        /* Thu nhỏ các thành phần bên trong Chatbot */
        .dap-fixed-chat-title {
            font-size: 1.05rem; /* Nhỏ hơn */
            font-weight: 850;
            margin: 0 0 0.4rem 0; /* Khoảng cách hẹp hơn */
            color: var(--text-color) !important;
        }
        .dap-chat-message-row {
            display: flex;
            align-items: flex-start;
            gap: 0.45rem; /* Gần nhau hơn */
            margin: 0.35rem 0; /* Khít hơn */
            padding: 0.45rem 0.55rem;
            border-radius: 12px;
            background: var(--background-color) !important; /* Dùng nền tương phản với nền panel */
        ...
        .dap-chat-avatar {
            flex: 0 0 24px; /* Thu nhỏ Avatar từ 32px xuống 24px */
            width: 24px;
            height: 24px;
            border-radius: 6px;
            display: inline-flex;
